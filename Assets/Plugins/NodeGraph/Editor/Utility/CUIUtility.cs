...
//						throw new NodeGraph.DataModelException(newTarget + " is not supported to build with this Unity. Please install platform support with installer(s).");
//					}
...
//					var result = NodeGraph.DataModelUtility.ExecuteGraph(target, graph);
...
//					var result = NodeGraph.DataModelUtility.ExecuteGraphCollection(target, c);
