...
namespace UFrame.NodeGraph
{
        ...
        private NodeView nodeDataDrawer
        {
            get
            {
                if (_nodeDataDrawer == null)
                {
                    ...
                    if (_nodeDataDrawer == null)
                        _nodeDataDrawer = m_controller?.CreateDefaultNodeView() ?? new NodeView();
    ...
    can not update any visual on Editor while building AssetBundles through NodeGraph.Data
*/
        ...
        public NodeGUI(NodeGraphController controller, NodeData data)
        {
            m_nodeWindowId = 0;
