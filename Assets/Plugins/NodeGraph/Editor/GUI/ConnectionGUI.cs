...
namespace UFrame.NodeGraph
{
    ...
    public class ConnectionGUI
    {
        ...
        public ConnectionGUI(ConnectionData data, ConnectionPointData output, ConnectionPointData input)
        {
