...
#if USE_SharpZipLib
            public static JSONObject LoadFromCompressedStream(System.IO.Stream aData)
{
            var zin = new ICSharpCode.SharpZipLib.BZip2.BZip2InputStream(aData);
return LoadFromStream(zin);
}
public static JSONObject LoadFromCompressedFile(string aFileName)
{
#if USE_FileIO
...
public static JSONObject LoadFromCompressedBase64(string aBase64)
{
