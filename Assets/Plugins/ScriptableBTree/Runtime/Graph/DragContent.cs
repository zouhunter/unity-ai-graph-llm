...
namespace MateAI.ScriptableBehaviourTree
{
    public class DragContent : MonoBehaviour, IPointerDownHandler, IDragHandler
    {
        ...
        // 限制当前面板在父节点中的区域位置  
        protected virtual void ClampToWindow()
        {
            // 面板位置  
